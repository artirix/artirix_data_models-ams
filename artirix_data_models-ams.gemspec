...
require 'artirix_data_models/ams/version'

Gem::Specification.new do |spec|
  spec.name          = 'artirix_data_models-ams'
  spec.version       = ArtirixDataModels::Ams::VERSION
  ...
  spec.add_dependency 'artirix_data_models', ['>= 0.16', '< 2']
